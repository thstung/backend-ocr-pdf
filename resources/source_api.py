...
from src.utils import convert_pdf2images
import cv2
import numpy as np
import uuid
    ...
    def post(self):
        ...
        if len(results['tables']) != 0:
            for table in results['tables']:
                ...
                tables_metadata.append({'table_id': id, 'table_coordinate': table['table_coordinate'], 'table_image': table['image'], 'table_data': table_data})
