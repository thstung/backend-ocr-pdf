...
from src.table_detection import table_detect
from src.table_structure_rec import table_structure_recognize
from src.ocr_image import ocr_image
...
def convert_pdf2images(pdf):
    ...
    for image in tqdm(images):
        base64_images.append({'page': convert_image_to_base64(image)})
